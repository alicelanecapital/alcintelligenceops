  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">This page wandered off the map.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "The Jungle · Origination Hub" },
      { name: "description", content: "AI-native origination operating platform for building a repeatable deal-flow engine." },
    ],
    links: [
